...
func AddCampaign(campaignname: String, campaignDescription: String, campaignPassword: String, completion: ((_ ok: Bool, _ message: String?, _ error: Error?) -> Void)?) {
    ...
    request.httpBody = try? JSONSerialization.data(withJSONObject: ["campaign_name": campaignname, "campaign_description": campaignDescription, "campaign_password": campaignPassword], options: []);
